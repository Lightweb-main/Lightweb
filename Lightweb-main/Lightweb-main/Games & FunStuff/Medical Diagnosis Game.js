...
commonColdInfoBtn.addEventListener("click", function(){
	...
	`
		<h2>Common Cold</h2>
		<h3>Background</h3>
		<p>The Common Cold is a mild pathogen, one of the most infectious in the world.</p>
		<h3>Symptoms</h3>
		When a human catches the common cold, they experience the following symptoms:
		<ul>
			<li>Coughing</li>
		...
		<h3>Duration</h3>
		<p>Symptoms usually fade away 7 to 11 days after the host has catched the Common Cold without any lasting symptoms.</p>
		<h3>Danger</h3>
		<p style="font-weight: bold">Severity/Danger: MILD</p>
		<p>The common cold isn't usually life-threatening but can possibly be to elderly, weakened and newborn. If the common cold poses a serious threat to the health of its host, the patient should take medicine and perform house remedies to prevent any permanent damage the Common Cold could inflict.</p>
...
allergiesInfoBtn.addEventListener("click", function(){
	...
	`
		<h2>Allergies</h2>
		<h3>Background</h3>
		<p>An allergy is a mild to severe immune system response to certain substances called <b>allergens</b>.</p>
		<h3>Symptoms</h3>
		Allergies can vary from person to person, but hosts commonly experience the following symptoms:
		<ul>
			<li>Coughing</li>
			<li>Irritating Nose</li>
			<li>Sneezing</li>
		...
		<h3>Duration</h3>
		<p>Allergies from foods can last from minutes to several hours after exposure from an allergen, but more severe reactions can possibly last for days.</p>
		<h3>Danger</h3>
		<p style="font-weight: bold">Severity/Danger: MILD-SEVERE</p>
		<p>An allergy can vary significantly in severity depending on the allergen and the host's immune system's response. Severe allergic reactions require immediate medical treatement.</p>
		<p>Unlike most pathogens, allergies cannot spread from person to person, but can happen through exposure to substances that trigger an immune response.</p>
	`	
});
...
influenzaInfoBtn.addEventListener("click", function(){
	...
	`
		<h2>Influenza</h2>
		<h3>Background</h3>
		<p>The Influenza, also called the Flu, is a mild to severe virus that primarily attacks the respiratory system of hosts and in severe cases causes respiratory failure, then death.
		<h3>Symptoms</h3>
...
covidInfoBtn.addEventListener("click", function(){
	...
	`
		<h2>Covid-19</h2>
		<p>Covid-19, or alternatively called Coronavirus, is a contagious : </p>
		<ul>
			<li>Coughing</li>
			<li>Fever</li>
			<li>Runny Nose</li>
