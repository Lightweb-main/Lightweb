 ...
 const TOTAL = 7;
	...
	const CorrectInscoreRatio = document.getElementById('CorrectIncorrectAnswerPercentage');
    ...
    function endQuiz() {
      ...
      CorrectAnswers.textContent = `You got ${score} / ${TOTAL}`;
	  CorrectInscoreRatio.textContent = `Percentage: ${Percent}%`;
	  LetterGradeVisual.textContent = `Grade: ${LetterGradeV2}`;
